...
def main():
    ...
    # Tạo dataset
    train_dataset = FoodDataset(TRAIN_PATH, transform=train_transform, max_samples=140)
    val_dataset = FoodDataset(VAL_PATH, transform=val_test_transform, max_samples=40)
    test_dataset = FoodDataset(TEST_PATH, transform=val_test_transform, max_samples=20)
