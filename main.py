...
def main():
    ...
    # Tạo dataset
    train_dataset = FoodDataset(TRAIN_PATH, transform=train_transform)
    val_dataset = FoodDataset(VAL_PATH, transform=val_test_transform)
    test_dataset = FoodDataset(TEST_PATH, transform=val_test_transform)
